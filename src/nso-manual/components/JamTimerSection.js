...
const Body = () => (
    <React.Fragment>
        ...
        <ul>
            <li>Skating Officials call an Official Timeout</li>
            <li>Serious injury or an injury that could endanger another participant</li>
            <li>Technical difficulty or mechanical malfunctions (including equipment and skate malfunctions)</li>
            <li>Interference by spectators</li>
            <li>Emergency situation</li>
            <li>Hazardous skating surface (debris or spills)</li>
        </ul>
        <p>
            The Jam Timer must call oﬀ the jam for these reasons (these may also be called oﬀ by Referees):
        </p>
        <ul>
            <li>End of two-minute Jam clock</li>
            <li>An injury that is a safety hazard to continued gameplay</li>
            <li>Fighting</li>
        </ul>
        <p>
        ...
        <ul>
            ...
            <li>After 1 minute blow one, long, rolling whistle and start the lineup</li>
            <li>Teams now have up to 30 seconds to position themselves on the track. The Head Referee may shorten this if they consider both teams to be ready, and will signal this</li>
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>If another jam should have occurred if no Timeout had been taken, or the Officials determine another Jam should occur, there should be another jam. End the Timeout as normal.</li>
                            <li>If another jam should not have occurred, unless a Team Timeout or Official Review was taken, the teams will be given a chance to call either once the Official Timeout is completed; otherwise the period will end.</li>
                        </ul>
                    </li>
                </ul>
            </li>
        ...
        <p>
            If the Jam time is oﬀ by more than 3 seconds, the Jam clock may be adjusted during the first 15 seconds of gameplay. If 15 seconds of gameplay have elapsed, do not modify the Jam clock. The period clock may only be adjusted during timeouts. Do not adjust the lineup and timeout clocks.
        </p>
        <p>
