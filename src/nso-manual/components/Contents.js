...
export const Contents = ({ pages }) => {
    return (
        <Paper sx={{ p: 2, m: 2, mt: 6 }}>
            ...
            <p>
                These documents were written based on the rule set established by the WFTDA Rules Committee for the 2023 season. They contain the policies and procedures used by the Rainy City Roller Derby Oﬃciating Crew, and are not endorsed by the Women’s Flat Track Derby Association.
            </p>
            <ul>
